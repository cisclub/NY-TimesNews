...
- (void)startShimmeringFromRightToLeft:(BOOL)fromRightToLeft;
{
    ...
    if (!fromRightToLeft) {
        ...
        gradient.startPoint = CGPointMake(1.0, 0.525);
        gradient.endPoint   = CGPointMake(0.0, 0.5); // slightly slanted forward
    }
